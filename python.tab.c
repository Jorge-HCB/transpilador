...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_ABREP = 3,                      /* ABREP  */
  YYSYMBOL_FECHAP = 4,                     /* FECHAP  */
  YYSYMBOL_ID = 5,                         /* ID  */
  YYSYMBOL_STR = 6,                        /* STR  */
  YYSYMBOL_NUM = 7,                        /* NUM  */
  YYSYMBOL_FIM_ENTRADA = 8,                /* FIM_ENTRADA  */
  YYSYMBOL_DOISP = 9,                      /* DOISP  */
  YYSYMBOL_WHILE = 10,                     /* WHILE  */
  YYSYMBOL_DO = 11,                        /* DO  */
  YYSYMBOL_SWITCH = 12,                    /* SWITCH  */
  YYSYMBOL_CASE = 13,                      /* CASE  */
  YYSYMBOL_DEFAULT = 14,                   /* DEFAULT  */
  YYSYMBOL_DIFERENTEIGUAL = 15,            /* DIFERENTEIGUAL  */
  YYSYMBOL_IGUALIGUAL = 16,                /* IGUALIGUAL  */
